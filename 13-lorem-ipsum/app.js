...
const textField = document.querySelector('.lorem-text')

form.addEventListener('submit', (e) => {
  e.preventDefault()

  const inputValue = allowedParagraphsNum(Number(input.value))
  // console.log(inputValue)
  const paragraphs = text.slice(0, inputValue)

  textField.innerHTML = paragraphs
    .map((paragraph) => {
...
function allowedParagraphsNum(num) {
  if (num < 1) {
    return (num = 1)
  } else if (num > 12) {
    return (num = 12)
